...
// creates new object that reshapes nationParksArray (for easier accessibility)
function createNationalParksObject(nationalParksArray) {
    var nationalParksObject = {};
    var park;

    // loop through each object in nationalParksArray,  create new identical object that has each state as key
            /* 
                    State: {
                        LocationID: "ABLI",
                        LocationName: "Abraham Lincoln Birthplace National Historical Park",
    ...
    for (park in nationalParksArray) {
        currentParkState = nationalParksArray[park].State; // gets the State of current park in nationalParksArray

        // console.log(currentParkState)

        nationalParksObject[currentParkState] = nationalParksArray[park]; // add currentParkState as key and its associated park info as value in new object 

        // console.log("STATE: ", nationalParksObject[currentParkState], "OBJECT OF STATE:", nationalParksArray[park])
    }
    ...
    return nationalParksObject;
}

window.nationalParks.nationalParksArray = nationalParksArray;
window.nationalParks.createNationalParksObject = createNationalParksObject;
